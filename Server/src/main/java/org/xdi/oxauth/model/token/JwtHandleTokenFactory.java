...
public class JwtHandleTokenFactory {
	...
	public static String generateHandleToken(final Client client,
        ...
        // Header
        SignatureAlgorithm signatureAlgorithm = SignatureAlgorithm.fromName(ConfigurationFactory.instance().getConfiguration().getTokenSigningType());
        ...
        switch (signatureAlgorithm) {
            ...
            case HS384:
            case HS512:
                HMACSigner hmacSigner = new HMACSigner(signatureAlgorithm, ConfigurationFactory.instance().getConfiguration().getTokenSigningKey());
